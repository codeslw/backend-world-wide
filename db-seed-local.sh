...
# 1. Create users
run_curl -X 'POST' \
  'http://localhost:3000/api/v1/users/create/many' \
...
run_curl -X 'POST' \
  'http://localhost:3000/api/v1/countries/create/many' \
  -H 'accept: */*' \
  -H 'Content-Type: application/json' \
  -d '{
  "countries": [
...
run_curl -X 'POST' \
  'http://localhost:3000/api/v1/cities/create/many' \
  -H 'accept: */*' \
  -H 'Content-Type: application/json' \
  -d '{
  "cities": [
...
run_curl -X 'POST' \
  'http://localhost:3000/api/v1/programs/create/many' \
  -H 'accept: */*' \
  -H 'Content-Type: application/json' \
  -d '{
  "programs": [
