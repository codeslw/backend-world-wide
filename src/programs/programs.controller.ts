...
export class ProgramsController {
  ...
  @ApiResponse({
    status: 409,
    description: 'Conflict - Program with these details already exists',
    type: ErrorResponseDto,
  })
  ...
  @ApiResponse({
    status: 409,
    description: 'Conflict - One or more programs already exist',
    type: ErrorResponseDto,
  })
  ...
  @ApiOperation({
    summary:
      'Get all programs with pagination and search, optionally filtered by parent ID',
  })
  @ApiQuery({
    name: 'parentId',
    required: false,
